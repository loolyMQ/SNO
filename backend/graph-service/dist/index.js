...
import { createKafkaClient, validateBody, graphNodeSchema, graphEdgeSchema, ConnectionPoolManager, MultiLevelCache, EnvironmentValidator, CommonMiddleware, VersionMiddleware } from '@science-map/shared';
const app = express();
...
const versionMiddleware = VersionMiddleware.create({
