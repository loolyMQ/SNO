...
export const httpRequestDuration = {
  labels: (labels: Record<string, string>) => ({
    observe: (value: number) => metricsCollector.observe('http_request_duration_seconds', value, labels)
  })
};
...
export const kafkaProcessingDuration = {
  labels: (labels: Record<string, string>) => ({
    observe: (value: number) => metricsCollector.observe('kafka_processing_duration_seconds', value, labels)
  })
};
