...
export class BackupEngine {
  ...
  private rtoConfigs: Map<string, RTOConfig> = new Map();
  ...
  async executeBackup(configId: string, type: BackupType = BackupType.FULL): Promise<BackupJob> {
  ...
  getMetrics(configId?: string): BackupMetrics {
    ...
    const lastBackup = successfulJobs.sort(
