...
export declare class LoggerFactory {
    ...
    static createStructuredLogger(service: string, customFields?: Record<string, any>): pino.Logger;
    static createChildLogger(parentLogger: pino.Logger, childFields: Record<string, any>): pino.Logger;
