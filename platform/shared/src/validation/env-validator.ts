...
export class EnvironmentValidator {
  ...
  private validateSecurityDefaults(errors: string[], _warnings: string[]): void {
  ...
  private validateDatabaseConfig(errors: string[], _warnings: string[]): void {
  ...
  private validateJWTConfig(errors: string[], _warnings: string[]): void {
  ...
  private validateRedisConfig(errors: string[], _warnings: string[]): void {
  ...
  private validateKafkaConfig(errors: string[], _warnings: string[]): void {
  ...
  validateServiceEnvironment(serviceName: string): EnvironmentValidationResult {
    const serviceConfigs: Record<string, { required: string[]; optional: string[] }> = {
      'auth-service': {
