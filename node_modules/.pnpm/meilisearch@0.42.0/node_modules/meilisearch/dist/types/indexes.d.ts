...
declare class Index<T extends Record<string, any> = Record<string, any>> {
     ...
     * @returns Promise containing the search response
     */
    searchSimilarDocuments<D extends Record<string, any> = T, S extends SearchParams = SearchParams>(params: SearchSimilarDocumentsParams): Promise<SearchResponse<D, S>>;
    /**
     ...
     * @returns Promise containing an EnqueuedTask
     */
    updateDocumentsByFunction(options: UpdateDocumentsByFunctionOptions): Promise<EnqueuedTask>;
    /**
     ...
     * @returns Promise containing an EnqueuedTask
     */
    updateLocalizedAttributes(localizedAttributes: LocalizedAttributes): Promise<EnqueuedTask>;
    /**
